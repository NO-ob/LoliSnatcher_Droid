# LoliSnatcher Droid   [![Github All Releases](https://img.shields.io/github/downloads/NO-ob/LoliSnatcher_Droid/total)](https://github.com/NO-ob/LoliSnatcher_Droid/releases) [![Discord](https://badgen.net/badge/icon/discord?icon=discord&label)](https://discord.gg/yD47ANdEXW) [![Translation Status](https://hosted.weblate.org/widget/loli-snatcher/svg-badge.svg)](https://hosted.weblate.org/engage/loli-snatcher/)
