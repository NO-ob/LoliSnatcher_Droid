  ...
  Future tagSearch(String input) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Logger.Inst().log('Tag search error:${response.statusCode}', "WorldXyzHandler", "tagSearch", LogTypes.booruHandlerInfo);
      }
    } catch(e) {
      Logger.Inst().log(e.toString(), "WorldXyzHandler", "tagSearch", LogTypes.exception);
      return [];
    }
    return searchTags;
  }
