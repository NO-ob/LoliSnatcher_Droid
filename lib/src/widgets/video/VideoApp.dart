...
import 'package:LoliSnatcher/src/widgets/video/LoliControls.dart';
import 'package:LoliSnatcher/src/widgets/common/TransparentPointer.dart';
...
class _VideoAppState extends State<VideoApp> {
  ...
  bool isVideoInit() {
    return chewieController?.videoPlayerController.value.isInitialized ?? false;
  }
