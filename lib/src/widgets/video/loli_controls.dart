...
class _LoliControlsState extends State<LoliControls> {
  ...
  void onHitAreaLongPressMove(LongPressMoveUpdateDetails details) {
    setState(() {
      // swiping 1/8th of the screen from starting point will add +1 to the base speed of 2, up to a max of 6
      longTapFastForwardSpeed =
          ...
          (double.tryParse(
              ...
              0);
      // limit between 2 and 6
      longTapFastForwardSpeed = longTapFastForwardSpeed.clamp(2, 6);
